...
var Compiler = (function () {
    ...
    Compiler.ApplyTemplate = function (templateName, html, javascript) {
        var templateFilePath = "templates/" + templateName + ".html";
    ...
    Compiler.Compile = function (directory, templateName) {
